            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Group {
                        ...
                        Text("• 1 tablespoon balsamic vinager")
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("3. In the meantime, on medium heat sautee shallot in a pan with oil until soft")
                    Text("4. Add brussel sprouts, seasonings, and vinager and stir on medium low heat for about 10 mintes")
                    Text("5. Once your bacon is done, chop into bite size pieces and add to the brussel sprouts, along with lemon juice.")
                    Text("6. Serve immediately, best eaten on it's own or as a side dish")
                }
                .font(.body)
                .foregroundColor(.gray)
                .padding(.bottom, 20)
